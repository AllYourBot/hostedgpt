...
ActiveRecord::Schema[7.1].define(version: 2024_09_02_024415) do
  ...
  create_table "language_models", force: :cascade do |t|
    ...
    t.decimal "input_token_cost_per_million", precision: 10, scale: 2, default: "0.0"
    t.decimal "output_token_cost_per_million", precision: 10, scale: 2, default: "0.0"
