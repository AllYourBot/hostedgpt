module User::Registerable
  ...
  def create_initial_assistants_etc
    open_ai_api_service = api_services.create!(url: "https://api.openai.com/", driver: APIService::DRIVER_OPEN_AI, name: "OpenAI")
   ...
   anthropic_api_service = api_services.create!(url: "https://api.anthropic.com/", driver: APIService::DRIVER_ANTHROPIC, name: "Anthropic")
