module User::Registerable
  ...
  def create_initial_assistants
    ...
    assistants.create! name: "Claude 3.5 Sonnet", language_model: LanguageModel.find_by(api_name: "claude-best")
    assistants.create! name: "Claude 3 Opus", language_model: LanguageModel.find_by(api_name: "claude-3-opus-20240229")
  end
end
