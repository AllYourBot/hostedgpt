...
module HostedGPT
  class Application < Rails::Application
    ...
    if Feature.password_reset_email?
      Feature.require_any_enabled!([:email_postmark], message: "\"PASSWORD_RESET_EMAIL_FEATURE\" requires an \"EMAIL_*_FEATURE\" feature to be enabled")
