...
class Conversation::BillableTest < ActiveSupport::TestCase
  ...
  test "removing a message decrements counts" do
    ...
    adjustments = message.attributes.symbolize_keys.slice(:input_token_count, :output_token_count)
    message.destroy
  ...
  test "updating values updates the rollups" do
    ...
    message_og = messages(:filter_map).attributes.symbolize_keys.slice(:input_token_count, :output_token_count)
    ...
    message_adjusted = messages(:filter_map).reload.attributes.symbolize_keys.slice(:input_token_count, :output_token_count)
